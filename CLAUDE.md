...
| `moods.json` | `MoodDef` — AteRawFood, AteFineFood, Catharsis, FoughtOffInfection, + 7 social moodlets + 6 ritual moodlets + 6 reputation moodlets + 4 aspiration moodlets + 16 warfare moodlets (RaidVictory, RaidDefeated, BattleHardened, ComradeFallen, etc.) |
